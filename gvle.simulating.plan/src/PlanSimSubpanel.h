...
class PlanSimSubpanelThread : public QObject
{
    Q_OBJECT
public:
    ...
    PlanSimSubpanelThread(std::vector<std::string>& logMessages,
            bool debug, int nbthreads, int blockSize);
    ~PlanSimSubpanelThread();
...
class PlanSimSubpanelLeftWidget : public QWidget
{
    Q_OBJECT
public:
    PlanSimSubpanelLeftWidget();
    ~PlanSimSubpanelLeftWidget();
    Ui::simpanelleft* ui;
...
class PlanSimSubpanelRightWidget : public QWidget
{
    Q_OBJECT
public:
    PlanSimSubpanelRightWidget();
    ~PlanSimSubpanelRightWidget();
    Ui::simpanelright* ui;
...
class PlanSimSubpanel : public PluginSimPanel
{
    Q_OBJECT
...
public:
    ...
    QString getString(const vle::value::Matrix& view, unsigned int col,
		     unsigned int row, bool error_message);
    ...
    PlanSimSubpanelLeftWidget* left;
    PlanSimSubpanelRightWidget* right;
    PlanSimSubpanelThread* sim_process;
    QThread* thread;
    vleVpz* mvpz;
    vle::utils::Package* mpkg;
    Logger* mLog;
