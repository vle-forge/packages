...
macro(VleCheckPackage _prefix _module_with_version)
  ...
  if (EXISTS "${_vle_include_dirs}" OR EXISTS "${_vle_lib_dirs}")
    ...
    if (VLE_DEBUG)
      message(STATUS "_vle_debug Found `${_module}': ${_vle_libraries} and "
                       "${_vle_include_dirs}")
    endif ()
...
macro(VleCheckDependencies)
  if (VLE_DEBUG)
    message(STATUS "vle_debug enter VleCheckDependencies")
  endif ()
  ...
  foreach(_vle_pkg_dep IN LISTS _vle_pkgs_deps)
    ...
    if (VLE_DEBUG)
      message(STATUS "_vle_debug VleCheckDependencies `${_prefix_pkg}',
                      '${_vle_pkg_dep}'")
    endif ()
