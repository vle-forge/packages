...
BOOST_AUTO_TEST_CASE(test_neverFail2)
{
    vle::Init app;
    {
        vmd::ex::KnowledgeBase b;
        b.plan().fill(std::string(vmd::ex::Plan4), 0);
...
BOOST_AUTO_TEST_CASE(test_neverFail3)
{
    vle::Init app;
    {
        vmd::ex::KnowledgeBase b;
        b.plan().fill(std::string(vmd::ex::Plan5), 0);
        ...
        b.applyFact("today", vle::value::Double(5.1));
        b.processChanges(5.1);
        BOOST_REQUIRE(act1.isInFailedState());
    }
}
