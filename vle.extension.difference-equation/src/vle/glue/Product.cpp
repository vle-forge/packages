...
class Product : public vle::extension::DifferenceEquation::Generic
{
public:
    Product(const vle::devs::DynamicsInit& init,
...
DECLARE_DYNAMICS(Product, glue::Product)
