...
class WeightedSum : public vle::extension::DifferenceEquation::Generic
{
public:
    WeightedSum(const vle::devs::DynamicsInit& init,
...
DECLARE_DYNAMICS(glue::WeightedSum)
