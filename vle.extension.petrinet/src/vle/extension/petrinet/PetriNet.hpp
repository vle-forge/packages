/*
 * @file vle/extension/petrinet/PetriNet.hpp
 *
...
#ifndef VLE_EXTENSION_PETRINET_PETRINET_HPP
#define VLE_EXTENSION_PETRINET_PETRINET_HPP

#include <vle/extension/petrinet/DllDefines.hpp>
...
namespace vle { namespace extension {
    ...
    public:
        ...
        /**
         * @brief Get a reference to the PetriNet's internal PRNG.
         *
         * @return A reference.
         */
        utils::Rand& rand() { return mRand; }
