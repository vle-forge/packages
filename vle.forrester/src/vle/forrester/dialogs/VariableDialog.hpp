/*
 * @file vle/forrester/dialogs/VariableDialog.hpp
 *
...
#ifndef VLE_GVLE_MODELING_FORRESTER_VARIABLE_DIALOG_HPP
#define VLE_GVLE_MODELING_FORRESTER_VARIABLE_DIALOG_HPP
 ...
 * @brief Launch a new window to modify a variable of the Forrester diagram
 */
class VariableDialog
{
public:
    VariableDialog(const Glib::RefPtr < Gtk::Builder >&,
        const Forrester&);

    VariableDialog(const Glib::RefPtr < Gtk::Builder >&,
        const Variable&, const Forrester&);
...
private:
    void onTextChange ();
    void init(const Glib::RefPtr < Gtk::Builder >&, const Variable&);
