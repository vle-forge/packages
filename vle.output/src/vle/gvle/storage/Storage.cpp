...
#include <vle/gvle/storage/Storage.hpp>
...
Storage::Storage(const std::string& package, const std::string& library)
    : OutputPlugin(package, library), m_dialog(0), m_rows(0), m_columns(0),
    m_rzrows(0), m_rzcolumns(0)
{
}
